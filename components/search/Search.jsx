import {FlatList, Pressable, Switch, Text, TextInput} from "react-native";
    ...
    return (<>
            ...
            {!isLoading ? <FlatList
                ...
                renderItem={({item}) => {
                    ...
                    return <GamePreview game={item} user_info={{shares_owned: usersShares}}
            ...
            <Pressable
                ...
                disabled={Math.floor(currentResults / 100) === searchPage}
            >
                <Text>Next Page</Text>
            </Pressable>
