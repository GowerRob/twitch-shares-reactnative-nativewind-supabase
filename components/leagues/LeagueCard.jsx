    ...
    return (
        ...
        <View className="bg-background-dark   my-5 mx-3 flex flex-column w-90 rounded-md">
            ...
            <View className="flex items-center mb-5">
                <Text
                    className="w-3/5 text-text-dark text-center text-xl my-2 border-solid border-2 border-primary-dark font-bold mx-2 rounded-lg">{leagueItem.league_name} </Text>
            </View>
